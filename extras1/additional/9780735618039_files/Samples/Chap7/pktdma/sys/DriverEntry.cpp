// Main program for pktdma driver
...
NTSTATUS AddDevice(IN PDRIVER_OBJECT DriverObject, IN PDEVICE_OBJECT pdo)
	...
	RtlInitUnicodeString(&devname, L"\\DosDevices\\PKTDMA");
	...
	do
		...
		// The S5933 requires DMA buffers be aligned on a 4-byte boundary

		if (fdo->AlignmentRequirement < 3)
			fdo->AlignmentRequirement = 3;
