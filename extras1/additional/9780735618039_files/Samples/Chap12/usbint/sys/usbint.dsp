# Microsoft Developer Studio Project File - Name="usbint" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=usbint - Win32 Checked
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "usbint.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "usbint.mak" CFG="usbint - Win32 Checked"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "usbint - Win32 Free" (based on "Win32 (x86) Application")
!MESSAGE "usbint - Win32 Checked" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 wdm.lib $(ddkpath)\lib\i386\free\usbd.lib generic.lib wmilib.lib /nologo /base:"0x10000" /version:5.1 /stack:0x40000,0x1000 /entry:"DriverEntry@8" /incremental:no /machine:IX86 /nodefaultlib /out:"objchk_wxp_x86\i386\usbint.sys" /libpath:"$(ddkpath)\lib\wxp\i386" /libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -align:0x80 -debug:full -driver:wdm -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -merge:_PAGE=PAGE -merge:_TEXT=.text -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -subsystem:native,4.00
# ADD LINK32 wdm.lib $(ddkpath)\lib\i386\free\usbd.lib generic.lib wmilib.lib /nologo /base:"0x10000" /version:5.1 /stack:0x40000,0x1000 /entry:"DriverEntry@8" /incremental:no /machine:IX86 /nodefaultlib /out:"objchk_wxp_x86\i386\usbint.sys" /libpath:"$(ddkpath)\lib\wxp\i386" /libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -align:0x80 -debug:full -driver:wdm -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -merge:_PAGE=PAGE -merge:_TEXT=.text -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -subsystem:native,4.00
# Begin Special Build Tool
TargetPath=.\objchk_wxp_x86\i386\usbint.sys
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(TargetPath) $(WINDIR)\system32\drivers	$(SIWPATH)\nmsym -translate:source,package,always $(TargetPath)
# End Special Build Tool
...
# Name "usbint - Win32 Free"
# Name "usbint - Win32 Checked"
