# Microsoft Developer Studio Project File - Name="wmi42" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=wmi42 - Win32 Checked
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "wmi42.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "wmi42.mak" CFG="wmi42 - Win32 Checked"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "wmi42 - Win32 Free" (based on "Win32 (x86) Application")
!MESSAGE "wmi42 - Win32 Checked" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 -nologo -align:0x80 -base:0x10000 -debug:full -debugtype:cv -debugtype:cv -driver:wdm -entry:DriverEntry@8 -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -incremental:no -libpath:"$(ddkpath)\lib\wxp\i386" -libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -merge:_PAGE=PAGE -merge:_TEXT=.text -nodefaultlib -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -stack:0x40000,0x1000 -subsystem:native,4.00 -version:5.1 wdm.lib wmilib.lib generic.lib  -out:objchk_wxp_x86\i386\wmi42.sys
# ADD LINK32 -nologo -align:0x80 -base:0x10000 -debug:full -debugtype:cv -debugtype:cv -driver:wdm -entry:DriverEntry@8 -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -incremental:no -libpath:"$(ddkpath)\lib\wxp\i386" -libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -merge:_PAGE=PAGE -merge:_TEXT=.text -nodefaultlib -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -stack:0x40000,0x1000 -subsystem:native,4.00 -version:5.1 wdm.lib wmilib.lib generic.lib  -out:objchk_wxp_x86\i386\wmi42.sys
# Begin Special Build Tool
TargetPath=.\objchk_wxp_x86\i386\wmi42.sys
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(TargetPath) $(WINDIR)\system32\drivers	$(SIWPATH)\nmsym -translate:source,package,always $(TargetPath)
# End Special Build Tool
...
# Name "wmi42 - Win32 Free"
# Name "wmi42 - Win32 Checked"
...
# Begin Custom Build - Compiling WMI Schema...
ProjDir=.
InputPath=.\wmi42.mof
InputName=wmi42
...
BuildCmds= \
	...
	$(DDKPATH)\bin\x86\wmimofck -h$(InputName).h $(ProjDir)\$(InputName).bmf \
	

"$(ProjDir)\$(InputName).bmf" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
