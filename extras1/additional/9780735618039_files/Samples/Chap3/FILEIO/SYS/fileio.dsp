...
!MESSAGE 
!MESSAGE NMAKE /f "fileio.mak" CFG="fileio - Win32 Checked"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "fileio - Win32 Free" (based on "Win32 (x86) Application")
!MESSAGE "fileio - Win32 Checked" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP /nologo /G6 /Gz /W3 /WX /O2 /I "$(wdmbook)\generic" /I "$(ddkpath)\inc\wxp" /I "$(ddkpath)\inc\ddk\wxp" /I "$(ddkpath)\inc\ddk\wdm\wxp" /I "$(ddkpath)\inc\crt" /I "$(ddkpath)\inc\win_me" /FI"$(ddkpath)\inc\wxp\warning.h" /D CONDITION_HANDLING=1 /D DBG=0 /D DEVL=1 /D "DRIVER" /D FPO=1 /D "NDEBUG" /D NT_INST=0 /D NT_UP=1 /D "STD_CALL" /D "WIN32" /D WIN32=100 /D WIN32_LEAN_AND_MEAN=1 /D WINNT=1 /D WINVER=0x0501 /D _DLL=1 /D "_IDWBUILD" /D "_MBCS" /D _NT1X_=100 /D _WIN32_IE=0x0600 /D _WIN32_WINNT=0x0501 /D "_WINDOWS" /D _X86_=1 /D i386=1 /FR /Yu"stddcls.h" /FD -GF -Oxs -QI0f -QIf -QIfdiv- -Zel  -cbstring /c
...
# ADD CPP /nologo /G6 /Gz /W3 /WX /Z7 /Oi /Gy /I "$(wdmbook)\generic" /I "$(ddkpath)\inc\wxp" /I "$(ddkpath)\inc\ddk\wxp" /I "$(ddkpath)\inc\ddk\wdm\wxp" /I "$(ddkpath)\inc\crt" /I "$(ddkpath)\inc\win_me" /FI"$(ddkpath)\inc\wxp\warning.h" /D CONDITION_HANDLING=1 /D DBG=1 /D DEVL=1 /D "DRIVER" /D FPO=0 /D "NDEBUG" /D NT_INST=0 /D NT_UP=1 /D "RDRDBG" /D "SRVDBG" /D "STD_CALL" /D "WIN32" /D WIN32=100 /D WIN32_LEAN_AND_MEAN=1 /D WINNT=1 /D WINVER=0x0501 /D "_DEBUG" /D _DLL=1 /D "_IDWBUILD" /D "_MBCS" /D _NT1X_=100 /D _WIN32_IE=0x0600 /D _WIN32_WINNT=0x0501 /D "_WINDOWS" /D _X86_=1 /D i386=1 /FR /Yu"stddcls.h" /FD -GF -QI0f -QIf -QIfdiv- -Zel  -cbstring /c
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 wdm.lib generic.lib wmilib.lib /nologo /base:"0x10000" /version:5.1 /stack:0x40000,0x1000 /entry:"DriverEntry@8" /incremental:no /machine:IX86 /nodefaultlib /out:"objchk_wxp_x86\i386\fileio.sys" /libpath:"$(ddkpath)\lib\wxp\i386" /libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -align:0x80 -debug:full -driver:wdm -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -merge:_PAGE=PAGE -merge:_TEXT=.text -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -subsystem:native,4.00
# ADD LINK32 wdm.lib generic.lib wmilib.lib $(ddkpath)\lib\win_me\vxdwraps.clb /nologo /base:"0x10000" /version:5.1 /stack:0x40000,0x1000 /entry:"DriverEntry@8" /incremental:no /machine:IX86 /nodefaultlib /out:"objchk_wxp_x86\i386\fileio.sys" /libpath:"$(ddkpath)\lib\wxp\i386" /libpath:"$(wdmbook)\generic\objchk_wxp_x86\i386" -align:0x80 -debug:full -driver:wdm -fullbuild -ignore:4010,4037,4039,4049,4065,4070,4078,4087,4089,4198,4221 -merge:_PAGE=PAGE -merge:_TEXT=.text -opt:icf -opt:nowin98 -opt:ref -osversion:4.00 -release -section:init,d -subsystem:native,4.00
# Begin Special Build Tool
TargetPath=.\objchk_wxp_x86\i386\fileio.sys
SOURCE="$(InputPath)"
PostBuild_Cmds=copy $(TargetPath) $(WINDIR)\system32\drivers	$(SIWPATH)\nmsym -translate:source,package,always $(TargetPath)
# End Special Build Tool
...
# Name "fileio - Win32 Free"
# Name "fileio - Win32 Checked"
