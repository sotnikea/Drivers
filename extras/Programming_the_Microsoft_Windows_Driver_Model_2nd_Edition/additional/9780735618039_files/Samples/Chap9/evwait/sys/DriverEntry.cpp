// Main program for evwait driver
...
NTSTATUS AddDevice(IN PDRIVER_OBJECT DriverObject, IN PDEVICE_OBJECT pdo)
	...
	RtlInitUnicodeString(&devname, L"\\DosDevices\\EVWAIT");
	...
	do
		...
		// Initialize the spin lock used for guarding access to the shared "event"
		// pointer in the device extension
