// Main program for usbint driver
...
extern "C" NTSTATUS DriverEntry(IN PDRIVER_OBJECT DriverObject,
	...
	// This driver needs a GetDevicePowerState callback, which was added to
	// GENERIC in version 1.10.

	if (GenericGetVersion() < 0x0001000A)
		{
		KdPrint((DRIVERNAME " - This driver needs GENERIC.SYS version 1.10\n"));
		return STATUS_UNSUCCESSFUL;
		}
